...
The final number of authors will depend on the individual contributions warranting authorship.   
...
**We welcome and actively encourage the participation of researchers from historically underrepresented and marginalized groups, 
...
- We welcome researchers from all backgroundswalks of life to contribute to any stage of this project (see below), but we especially encourage those self-identifying as part of historically underrepresented and marginalized groups in science and academia.  
...
- We had our first virtual hackathon during the SORTEE (Society for Open Reliable Transparent Ecology and Evolutionary Biology) conference in October 2025, but participation in this event was not mandatory. We can schedule additional virtual hackathons/meetings with the project leads and/or other project contributors on request from team members. Participation in a hackathon is not compulsory.  
...
- We expect all project contributors to familiarize themselves with and follow our Code of Conduct (see below).  
...
will be acknowledged as project contributors on the project page, report, presentations, and manuscript. 
We will mainly use a CRediT-like statement format, but we will also keep a more detailed record of individual
contributions to specific tasks within the stages of the project. This record will be also made publicly
available as part of the open project materials (as a publicly available dataset and  within the final report). 
You can request to have your details removed or obscured at any time.    
